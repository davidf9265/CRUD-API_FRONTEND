...
const styles= useStyles();
  ...
  const peticionPut=async()=>{
    await axios.put(baseUrl+'/'+consolaSeleccionada.IdContacto, consolaSeleccionada)
    .then(response=>{
      var dataNueva=data;
      dataNueva.map(consola=>{
        if(consolaSeleccionada.IdContacto===consola.IdContacto){
          consola.Nombre=consolaSeleccionada.nombre;
          consola.Apellido_1=consolaSeleccionada.Apellido_1;
          consola.Apellido_2=consolaSeleccionada.Apellido_2;
  ...
  const peticionDelete=async()=>{
    await axios.delete(baseUrl+'/'+consolaSeleccionada.IdContacto)
    .then(response=>{
      setData(data.filter(consola=>consola.IdContacto!==consolaSeleccionada.IdContacto));
  ...
  const bodyInsertar=(
    <div className={styles.modal}>
      ...
      <br />
      <TextField name="Apellido_1" className={styles.inputMaterial} label="Primer Apellido" onChange={handleChange}/>
      <br />
      <TextField name="Apellido_2" className={styles.inputMaterial} label="Segundo Apellido" onChange={handleChange}/>
      <br />
  ...
  const bodyEditar=(
    <div className={styles.modal}>
      ...
      <br />
      <TextField name="Apellido_1" className={styles.inputMaterial} label="Primer Apellido" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.Apellido_1}/>
      <br />
      <TextField name="Apellido_2" className={styles.inputMaterial} label="Segundo Apellido" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.Apellido_2}/>
      <br />
      ...
      <br />
      <TextField name="celular" className={styles.inputMaterial} label="Celular" onChange={handleChange} value={consolaSeleccionada && consolaSeleccionada.celular}/>
      <br />
    ...
    <Button onClick={()=>abrirCerrarModalInsertar()}>Insertar</Button>
     ...
     <TableContainer>
       <Table>
         ...
         <TableBody>
           {data.map(consola=>(
             <TableRow key={consola.IdContacto}>
               <TableCell>{consola.Nombre}</TableCell>
               <TableCell>{consola.Apellido_1}</TableCell>
               <TableCell>{consola.Apellido_2}</TableCell>
